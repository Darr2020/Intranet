          ...
          <div class="container-fluid">
            <div class="input-div one">
              ...
              <div>
                  ...
                  <input class="inputModal" type="text" name="name" value="<?php echo e(old('name')); ?>" v-model="name">
              </div>                   
            </div>
...
</form><?php /**PATH /var/www/html/sistemas/intranet2/resources/views/partials/tasks/create.blade.php ENDPATH**/ ?>