        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="i">
                        <img src=" <?php echo e(asset('icons/task.svg')); ?> ">
                    </div>
                    <div>
                        <h5 class="focus">Tarea</h5>
                        <input class="inputModal" type="text" name="name" value="<?php echo e(old('name')); ?>" v-model="fillTask.name">
                    </div>                   
                    </div>
                    <div class="input-div two">
                        <div class="i">
                            <img src=" <?php echo e(asset('icons/description.svg')); ?> ">
                        </div>
                        <div>
                            <h5>Descripción</h5>
...
</form><?php /**PATH /var/www/html/sistemas/intranet2/resources/views/partials/tasks/edit.blade.php ENDPATH**/ ?>